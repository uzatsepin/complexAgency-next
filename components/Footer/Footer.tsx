    ...
    return (
        <footer
            ...
            <div className="text-center mt-14">
                <div className="text-white/70 text-md">© 2023-2024, Complex Agency - <a className="text-[#2CEEC2]" href="mailto:thecomplexagency@gmail.com">thecomplexagency@gmail.com</a></div>
