...
import PortfolioCardAdmin from "@/components/MainPage/Works/PortfolioCard/PortfolioCardAdmin";
            ...
            <div className="flex justify-between pb-4 border-b border-b-[#2EECC5]">
                <div>
                    ...
                    <p className="mt-2 text-lg text-white/80">
                        На даний момент додано робіт: <span
                        className="font-bold text-xl">{portfolioItems.length}</span>
                    </p>
                </div>
                <div>
                    <div
